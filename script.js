...
const timeOutput = document.querySelector('.temp');
...
function fetchWeatherData(){
    fetch('http://api.weatherapi.com/v1/current.json?key=1f4d37937da54f4291d113307241506=$(cityInput)')
    .then(response=>response.json())
    .then(data => {
        console.log(data);
        temp.innerHTML=data.current.temp_c+"&#176;";
        conditionOutput.innerHTML=data.current.condtition.text;
